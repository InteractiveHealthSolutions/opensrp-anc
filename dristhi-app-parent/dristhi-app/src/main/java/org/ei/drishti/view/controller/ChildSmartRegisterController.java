    ...
    private void sortByName(List<ChildClient> childrenClient) {
        sort(childrenClient, new Comparator<ChildClient>() {
            ...
            //    return oneChild.motherName().compareToIgnoreCase(anotherChild.motherName());
            	if(oneChild.motherName()==null)
            	{
            	
            		if(anotherChild.motherName()==null)
            		{
            			
            		return 	"".compareToIgnoreCase("");
            		}else
            		{
            		return "".compareToIgnoreCase(anotherChild.motherName());
            		}
            	}
            	else if(anotherChild.motherName()==null)
            	{
            		return oneChild.motherName().compareToIgnoreCase("");
            	}else{
